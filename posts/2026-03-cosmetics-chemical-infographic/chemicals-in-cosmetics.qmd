...
I used two fonts throughout the infographic. - Jost for subheadings and paragraphs. It is clean and easy to read at small sizes.
...
The main message is harmful chemicals are common in cosmetics at every price level. Expensive luxury brands are not always cleaner, even though they cost more. At the same time, more affordable products also show surprising patterns. The woman thinking "Which one to buy?" at the bottom brings it back to the reader personally. Every chart tries to build the case.
...
# Read data
cscp_data <- read_csv(here::here("posts", "2026-03-cosmetics-chemical-infographic", "data", "cscpopendata.csv")) %>%
  clean_names()
