...
citation: 
  url: https://aakriti-poudel-chhetri.github.io/posts/2026-03-econometrics/
categories: [MEDS, Environmental policy, Econometrics, R, data science]
image: image/indonesia.png
draft: false
---

#### [Repository Link](https://github.com/aakriti-poudel-chhetri/eds241-final-project)
...
# Read in data
irrigation <- read_csv(here::here("posts", "2026-03-econometrics", "data", "irrigation_data.csv"))
```
