...
library(knitr)
# Working directory for all chunks
...
#| fig-cap: "The plot shows the annual mean carbon emissions from 2015 to 2024 for the ten highest-emitting countries. This allows us to visualize trends over time."
...
#| fig-cap: "The plot shows the annual mean GDP from 2015 to 2024 for the ten countries with the highest GDP. This allows us to visualize economic growth trends over time."
...
```{r}
#| label: fig-decoupling-countries
#| fig-cap: "The plot shows the top ten countries with the most years where GDP increased and carbon emissions decreased. Each bar represents the number of years a country experienced this decoupling effect."
...
We fit GDP and emissions data into the negative binomial model to quantify the relationship between economic growth and carbon emissions. This allows us to understand whether changes in GDP are associated with changes in emissions and to make predictions or draw inferences based on the model.

$$
\begin{align}
\text{decoupling\_years} &\sim \text{NegativeBinomial}(\mu, \theta) \\
\log(\mu) &= \beta_0 + \beta_1\,\text{avg\_emission\_reduction} + \beta_2\,\text{avg\_gdp\_growth}
\end{align}
$$
