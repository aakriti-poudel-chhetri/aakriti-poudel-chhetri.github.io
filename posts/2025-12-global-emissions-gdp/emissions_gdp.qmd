...
opts_knit$set(root.dir = "/Users/aakriti/Documents/MEDS/My website/aakriti-poudel-chhetri.github.io")
```
...
```{r}
#| label: model
#| fig-cap: "Figure 2: Negative Binomial Model"
...
#| fig-cap: "Figure 3: The plot shows the annual mean carbon emissions from 2015 to 2024 for the ten highest-emitting countries. This allows us to visualize trends over time."
...
Figure 3 shows that the highest‐emitting countries are China, United States, India, Russia, Japan, Saudi Arabia, Indonesia, South Africa, Korea and Iran.
...
#| fig-cap: "Figure 4: The plot shows the annual mean GDP from 2015 to 2024 for the ten countries with the highest GDP. This allows us to visualize economic growth trends over time."
...
Figure 4 indicates that the countries with the highest GDP are United States, China, Japan, Germany, the United Kingdom, India, France, Italy, Brazil and Canada.
...
#| fig-cap: "Figure 5: The plot shows the top ten countries with the most years where GDP increased and carbon emissions decreased. Each bar represents the number of years a country experienced this decoupling effect."
...
Figure 5 highlights the countries that achieved the decoupling case: Ireland, Romania, Bulgaria, Luxembourg, the Netherlands, Poland, Portugal, Ukraine, United States and Australia.
...
We fit GDP and emissions data into the following negative binomial model to quantify the relationship between economic growth and carbon emissions. This allows us to understand whether changes in GDP are associated with changes in emissions and to make predictions or draw inferences based on the model.

$$
\begin{align}
\text{decoupling_years} &\sim \text{NegativeBinomial}(\mu, \theta) \\ 
...
#| fig-cap: "Figure 6: The plot visualizes the model predictions for the number of decoupling years as GDP increases and emission decreases. The pink line shows the predicted values of declining emissions, the shaded blue area represents the 95% confidence interval at the mean emission reduction, and the green points indicate the observed decoupling cases for each country."
